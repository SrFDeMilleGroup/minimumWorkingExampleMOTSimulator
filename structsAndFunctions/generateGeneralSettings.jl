module generalSettings
    ...
    function generateGeneralSettings(mol::Molecule)::GeneralSettings
        ...
        return GeneralSettings(simulationType, numTrialsPerValueSet, forceProfile, displacementsInMM, initDispDir, longSpeeds, userSpeeds, velDirRelToR, bFieldSetting, bGradReal, bGrad)
